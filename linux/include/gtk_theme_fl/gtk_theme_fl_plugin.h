#ifndef FLUTTER_PLUGIN_GTK_THEME_FL_PLUGIN_H_
#define FLUTTER_PLUGIN_GTK_THEME_FL_PLUGIN_H_
...
typedef struct _GtkThemeFlPlugin GtkThemeFlPlugin;
typedef struct {
  GObjectClass parent_class;
} GtkThemeFlPluginClass;
